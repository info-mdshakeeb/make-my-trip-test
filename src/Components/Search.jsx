...
const Search = ({ type, data }) => {
    ...
    return (
        <div className='h-60 shadow-md w-[340px] bg-white overflow-y-scroll mt-3 rounded-md z-30 relative'>
            <form className="mb-5 sticky top-0">
                <input
                    ...
                    searchData.map((item, i) => (
                        <div key={i} onClick={handelClose}>
                            <div
                                ...
                                className="flex items-center border-b p-1 cursor-pointer hover:bg-[#eaf5ff] transition duration-400 ease-in-out text-sm">
